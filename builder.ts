...
export { actionsCore as core, actionsGithub as github, actionsIo as io, actionsTc as tc }
...
export function downloadTool(url: string, dest?: string, auth?: string): Promise<string> {
...
export function extractTar(file: string, dest?: string, flags?: string | string[]): Promise<string> {
...
export function globber(pattern: string, options?: GlobOptions): Promise<Globber> {
